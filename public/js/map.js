...
let attractions = [{
    ...
    img: '"http://mmweb.tw/sys/news/img/pic_tainan_1_20130116111239.jp://upload.wikimedia.org/wikipedia/commons/b/bd/P1060292_min.jpg"',
  },{
    name: '臺南廳長官邸 ',
    position: {lat: 22.993790, lng: 120.214946},
    type: 'monuments',
    distance: Number.MAX_SAFE_INTEGER,  
    content: '歷史背景：建於西元1898～1906年間。臺南廳長官邸是日治初期三縣三廳時期，臺南地區最高行政長官臺南廳廳長的宿舍，後為臺南州知事、內務部長官邸，光復後也曾做為政府高官官邸，並派駐有警衛人員，最後作為臺南一中教職員宿舍。後來因疏於照護而荒廢，直至2017年9月修復完成重新啟用，現為臺南市長接待外賓時的接待所。建築形式採用明治時期流行的「和洋二館」式建築：北棟為西洋建築的洋館，修復後整體狀況良好，裡面擺設典雅，從內裝到家具都富有古典風格，南棟為日式建築的和館，只是因為年久失修的關係，目前和館只剩地基與地板的花磚，2017年9月14日修復完成後首次開放參觀吸引了許多民眾進入一探究竟，目前僅每周五、六、日開放民眾進入參觀。 地址： 臺南市東區育樂街197巷2號創立年代：西元1896-1906年',
    ...
    type: 'monuments',
    distance: Number.MAX_SAFE_INTEGER,
    content: ' 歷史背景： 早期臺南枋橋頭的吳家，自吳春貴承販臺鹽致富，而後其子吳尚新繼承家業，於徙建洲南場後，承銷食鹽業務大為發展，家境日隆。道光初，吳尚新乃將其宅第北邊原屬荷治時期荷蘭通事何斌的庭園舊址加以收購，沿著地勢高低建構庭園，並聘名匠仿照漳州城外飛來峰的形勢，佈置假山、池臺水閣、奇花異木，極盡美觀，名為「吳園」，俗稱「樓仔內」，與板橋「林家花園」、新竹「北郭園」、霧峰「萊園」等號稱臺灣四大名園。因當時吳家的財富為府城之冠，庭園的美輪美奐，亦堪稱甲於全臺，所以臺南有句俚諺說：「有樓仔內有的富，也無樓仔內的厝；有樓仔內有的厝，也無樓仔內的富」；連雅堂於＜臺南古蹟志＞亦言：「枋橋吳氏，為府治巨室，園庭之勝甲全臺，而非來峰尤最。」可知唔加當時的財富與宅第庭園構築的精雅一般。創建至今達一百七十餘年，如今侷促臺南市區一隅，僅餘「仿飛來」假山、水池、池畔閩南平房、捲棚歇山頂四角涼亭與六角攢間涼亭各一座、石砌廊道和一畔庭園。雖大部分建築房舍外觀大異從前，但假山、水池和四角涼亭（作勵軒）尚維持一定型制，就整體而言，尚保有部份的傳統園林風格。地址： 臺南市中西區民權路二段30號創立年代：西元1828年 ',
    ...
    type: 'monuments',
    distance: Number.MAX_SAFE_INTEGER,
    content: '歷史背景：建於西元 1911  年，由中央入口、兩側翼部以及後棟大會堂所組成。公會堂前棟，形式為西方歷史式樣，屋頂是極為特殊的形式，成為其不同於其他建築的重要特色。中央入口部分可視為由兩根兩層樓高方柱撐起之三角形山牆所構成，為全棟建築最高之屋頂，兩根方柱內側為闈內凹一圓拱圈。兩翼部分，高兩層樓約十二米，採磚砌承重構造。大會堂，與本體正後方斜接，因教著重機能，外觀簡單樸素，大會堂後部舞臺下方有一磚砌拱圈構造的地下室，可能為因應基地高差而設置的擋土結構基礎。地址： 臺南市中西區民權路二段30號創立年代：西元1911年 ',
    ...
    type: 'monuments',
    distance: Number.MAX_SAFE_INTEGER,
    content: '歷史背景：早期禾寮港用於貨運運輸，為五條港新港德慶溪下游西段，其中在現今民族路與成功路之間的溪段，現已地下化（忠義路二段202巷）。遠在荷據時代已有不少人居住於禾寮港兩側，西元1661年鄭成功便由此登岸的，因附近街市稱之為禾寮街，故稱之為禾寮港。地址：臺南市中西區忠義路二段202巷'   ,
    ...
    type: 'monuments',
    distance: Number.MAX_SAFE_INTEGER,
    content: '歷史背景：民族戲院在1963年開幕。在其他戲院都紛紛轉型求生存的艱苦年代，民族戲院的生意維持很好，因為臨近繁華的民族夜市。民族夜市是街道型夜市，沿著民族路一路從赤崁樓到現在中山路老曾羊肉附近，繁華興盛的場面看照片就知道。由於夜市人潮嚴重影響交通與衛生，所以當時市長蘇南成大刀闊斧拆除民族夜市。間接導致民族戲院失去人潮而走下坡，民族戲院正式在2000年結束營業。現已成為補習班，但外牆仍有部分當年戲院的痕跡。 地址： 臺南市中西區民族路二段249號創立年代：西元1963年' , 
    ...
    type: 'monuments',
    distance: Number.MAX_SAFE_INTEGER,
    content: '歷史背景： 創建於西元1662年，位於當時鎮北坊德慶溪出口南岸的水仔尾，是臺南市最早興建的媽祖廟，故以開基冠稱。鄭成功治臺後，感恩昔日馬祖庇佑鄭軍順利登港，將開基天后宮易茅為瓦，易寮為廟，冠以「開基」，因不及大天后宮的規模及寬敞，俗稱「小媽祖廟」。是一座二進縱深式建築，坐東朝西。第一進為前殿，第二進為拜亭的正殿，但因拜亭與前殿之間，沒有內埕分隔，渾然成為一體。正殿供奉馬祖神像，左右配祀千里眼、順風耳兩將軍神像，第三進為後殿，祀奉觀世音菩薩。     地址： 臺南市北區自強街12號  創立年代：西元1662年',
    ...
    type: 'monuments',
    distance: Number.MAX_SAFE_INTEGER,
    content: '歷史背景： 鴨母寮市場名稱由來有不同說法，較為採信之說法為，當時市場旁有戶住家養鴨，因常將鴨放養在德慶溪流上，鴨母多在水中下蛋，主人再於溪中撈取鴨蛋而得名。日治時期稱之為「明治分市場」，光復後改為「光復市場」，但老臺南人還是喜稱為鴨母寮市場，直至西元2007年才正名為「鴨母寮市場」。鴨母寮市場已近三百年歷史，是臺南市重要的市集之一，許多臺南人從小便隨父母在其市場中採買物品，在生長過程中佔有極大的地位。 地址： 臺南市中西區民權路二段30號創立年代：西元1911年 ',
    img: '"http://web.topwin.com.tw/WalkToTaiwan/UpLoad/Photo/F00002159.jpg"',
  },{
    name: '拱乾門',
    ...
    type: 'monuments',
    distance: Number.MAX_SAFE_INTEGER,
    content: '歷史背景： 清道光12年張丙之亂(西元1832年)後，於大西門之外加建三座城門，以加強安全，拱乾門為其中之一，位於北邊，剛好在小北門之西南側，於德慶溪北側，距離相當近，日治時期因都市改正而拆除。地址:台南市北區臨安路二段與民德路交叉口創立年代:清道光13年(西元1833年)地址： 臺南市北區海安路三段12號 創立年代：西元1832年',
    img: '"../images/door.jpg"',
  },{
    name: '台南三山國王廟',
